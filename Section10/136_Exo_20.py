...
def task3(name: str, club: str) -> namedtuple:
    ...
    """
    # you code starts here:
    # n = namedtuple('name': name, 'club': club)
    Player = namedtuple('Account', ['name', 'club'])
    p = Player(name, club)
    return p
...
# di = OrderedDict({'Alan': 'Manchester', 'Bob': 'Valence', 'Dan': 'City', 'Lolo': 'Valence', 'Bobo': 'City'})
# task2(di)
friends = deque(('1', '2', '3', '4', '5'))
task4(friends)
